...
#==== export  ====# 
export(plot_data, "03_regression/03_output/01_plot_data_reg_wage_age.xlsx")
export(peak_point, "03_regression/03_output/01_peak_point_reg_wage_age.xlsx")
export(model, "03_regression/03_output/01_model_reg_wage_age.rds")
