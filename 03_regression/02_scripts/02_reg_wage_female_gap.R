...
export(model1, "03_regression/03_output/02_model1_reg_gap_female.rds")
...
export(model2, "03_regression/03_output/02_model2_reg_gap_female.rds")
...
export(model3, "03_regression/03_output/02_model3_reg_gap_female.rds")
...
summary(model4)
export(model4, "03_regression/03_output/02_model4_reg_gap_female.rds")
...
summary(model5)
export(model5, "03_regression/03_output/02_model5_reg_gap_female.rds")
