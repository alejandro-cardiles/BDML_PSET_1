...
model4 = import("04_regression/03_output/model4_reg_gap_female.rds")
model5 = import("04_regression/03_output/model5_reg_gap_female.rds")

# for graph
plot_data = import( "04_regression/03_output/plot_data.rds")
peak_point = import( "04_regression/03_output/peak_points.rds")
...
etable(model1, model4, model5,
       ...
       file = "06_visual/output/03_model_gender_gap.tex")
...
plot
#==== export  ====# 
ggsave(plot, filename = "06_visual/output/03_plot_reg_wage_age_gender.png",   width = 8, height = 4, units = "in", dpi = 300)
